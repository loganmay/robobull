...
/***/ function(module, exports, __webpack_require__) {
		...
		_createClass(App, [{
			...
			value: function componentWillMount() {
				...
				setInterval(function () {
					fetch('https://hackpsu-2017spring-yehyaawad.c9users.io:8081/amount').then(function (response) {
						return response.json();
					}).then(function (_ref) {
						var amount = _ref.amount;
						return _this.setState({ amount: amount.toFixed(2) });
					});
				}, 200);
			}
		}, {
			...
			key: 'calcProbsLeft',
			value: function calcProbsLeft() {
				var probsLeft = (Number(this.state.allowance) - this.state.amount) / this.state.cashPerProb;
				return probsLeft;
			}
		}, {
			key: 'render',
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(Notification, { completed: this.state.completed, ref: 'n', clear: this.clearNote.bind(this) }),
					_react2.default.createElement(
						'div',
						{ className: 'container', style: { width: '95%' } },
						_react2.default.createElement(WeekTabMenu, {
							amount: this.state.amount,
							allowance: this.state.allowance,
							probsLeft: this.calcProbsLeft(),
							view: this.state.tabView
						}),
						_react2.default.createElement('hr', null),
						_react2.default.createElement(
							_Button2.default,
							{ href: 'https://www.ixl.com/', style: { width: '48%', paddingTop: '15px', paddingBottom: '15px', marginRight: '2%', marginTop: '25px', fontSize: '20px', backgroundColor: '#2196f3', color: 'white' } },
							'Play Games'
						),
						_react2.default.createElement(
							_Button2.default,
							{ href: 'http://amazon.com', style: { width: '48%', paddingTop: '15px', paddingBottom: '15px', marginTop: '25px', fontSize: '20px' } },
							'Shop'
						),
						_react2.default.createElement(WishList, { amount: this.state.amount }),
						_react2.default.createElement('hr', null),
						_react2.default.createElement(Stats, { amount: this.state.amount, spent: this.state.spent, earnings: this.state.earnings })
					)
				);
			}
		}]);
	...
	var Header = function Header() {
		return _react2.default.createElement(
			'div',
			{ style: { backgroundColor: '#2196f3', display: 'flex', justifyContent: 'space-between', alignItems: 'center', textAlign: 'center' } },
			_react2.default.createElement(
				'p',
				{ style: { color: 'white', fontSize: '20px', flexGrow: '1', marginBottom: '0', flexBasis: '25%', display: 'flex', justifyContent: 'flex-start', alignItems: 'center' } },
				_react2.default.createElement('img', { src: 'http://logan-may.com/wp-content/uploads/2017/04/Priority_Logan-e1491699002557.jpg', style: { borderRadius: '100px', width: '50px', height: '50px', margin: '10px' } }),
				_react2.default.createElement('span', { className: 'glyphicon glyphicon-chevron-down' })
			),
			_react2.default.createElement(
				'h1',
				{ style: { paddingTop: '15px', paddingBottom: '15px', margin: '0', color: '#fff', flexGrow: '5', flexBasis: '50%' } },
				_react2.default.createElement('img', { src: 'http://hackpsu-2017spring-yehyaawad.c9users.io:8081/img/logo.png', height: '70px' })
			),
			_react2.default.createElement(
				'p',
				{ style: { color: 'white', fontSize: '20px', flexGrow: '1', marginBottom: '0', flexBasis: '25%', textAlign: 'right', marginRight: '25px' } },
				_react2.default.createElement(
					'a',
		...
		_createClass(Notification, [{
			...
			value: function render() {
				if (this.props.completed == true) {
					return _react2.default.createElement(
						'div',
						{ className: 'jumbotron', style: { width: '100%', borderLeft: '4px solid red', marginLeft: '0%', marginRight: '0%', fontSize: '30px', marginTop: '0px', backgroundColor: 'red', textAlign: 'center' } },
						_react2.default.createElement(
							'div',
							{ onClick: this.clearNot.bind(this), style: { color: 'white', position: 'relative', top: '-51px', width: '50px', float: 'left' } },
							'x'
						),
						_react2.default.createElement(
							'p',
							{ style: { color: 'white', fontSize: '25px', position: 'relative', left: '-20px' } },
							_react2.default.createElement(
								'strong',
								null,
								_react2.default.createElement('span', { className: 'glyphicon glyphicon-ice-lolly' }),
								'You haven\'t earned your full allowance this week.'
							),
							' ',
					...
					return _react2.default.createElement('div', { style: { width: '100%', height: '50px' } });
				}
			}
		}]);
	...
	var WeekTabMenu = function (_React$Component3) {
		_inherits(WeekTabMenu, _React$Component3);

		function WeekTabMenu() {
			_classCallCheck(this, WeekTabMenu);

			var _this4 = _possibleConstructorReturn(this, (WeekTabMenu.__proto__ || Object.getPrototypeOf(WeekTabMenu)).call(this));
		...
		_createClass(WeekTabMenu, [{
			key: 'changeView',
			value: function changeView(v) {
				if (v == 'clock') {
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'ul',
						{ className: 'nav nav-tabs', role: 'tablist', 'data-tabs': 'tabs', style: { width: '95%', textAlign: 'center', marginLeft: '6%' } },
						_react2.default.createElement(
							'li',
							null,
							_react2.default.createElement(
								'a',
								{ 'data-toggle': 'tab', ref: 'tc', style: { fontSize: '45px' }, onClick: function onClick() {
										return _this5.changeView('clock');
									} },
								'Clock'
							)
						),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{ 'data-toggle': 'tab', ref: 'ta', className: 'activeTab', style: { fontSize: '45px' }, onClick: function onClick() {
										return _this5.changeView('allowance');
									} },
								'Allowance'
							)
						),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{ 'data-toggle': 'tab', ref: 'tp', style: { fontSize: '45px' }, onClick: function onClick() {
										return _this5.changeView('problems');
									} },
								'Problems'
							)
						)
					...
					_react2.default.createElement(
						'div',
						{ className: 'tab-content', style: { marginTop: '40px' } },
						_react2.default.createElement(
							'div',
							{ style: { display: 'none' }, ref: 'c', id: 'clock' },
						...
						_react2.default.createElement(
							'div',
							{ style: { display: 'block' }, ref: 'a', id: 'allowance' },
							_react2.default.createElement(
								'h1',
								null,
								'$',
								this.props.amount,
								' / $',
								this.properNum(this.props.allowance)
							),
							_react2.default.createElement(
								'p',
								{ style: { fontSize: '20px' } },
								'Total dollars earned this week'
							)
						),
						_react2.default.createElement(
							'div',
							{ style: { display: 'none' }, ref: 'p', id: 'problems' },
							_react2.default.createElement(
								'h1',
								null,
								this.props.probsLeft,
								' more problems'
							),
							_react2.default.createElement(
								'p',
								{ style: { fontSize: '20px' } },
								'Needed to complete this week'
							)
						)
					)
				);
	...
	var WishList = function (_React$Component4) {
		_inherits(WishList, _React$Component4);

		function WishList() {
			_classCallCheck(this, WishList);

			var _this6 = _possibleConstructorReturn(this, (WishList.__proto__ || Object.getPrototypeOf(WishList)).call(this));

			_this6.state = {
				items: [{
					name: "The Lorax by Dr. Suess",
					cost: 7.38,
					allowance: 0
				}, {
		...
		_createClass(WishList, [{
			key: 'amazon',
			value: function amazon(link) {
				var lorax = "https://www.amazon.com/Lorax-Classic-Seuss-Dr/dp/0394823370/ref=sr_1_1?ie=UTF8&qid=1491748474&sr=8-1&keywords=the+lorax";
				var pi = "https://www.amazon.com/Raspberry-Model-A1-2GHz-64-bit-quad-core/dp/B01CD5VC92/ref=sr_1_1?s=pc&ie=UTF8&qid=1491748664&sr=1-1&keywords=raspberry+pi";
				var drone = "https://www.amazon.com/DJI-Phantom-P3-STANDARD-Quadcopter-Camera/dp/B013U0F6EQ/ref=sr_1_1?s=electronics&ie=UTF8&qid=1491749337&sr=1-1&keywords=phantom+3";
				var sat = "https://www.amazon.com/Official-SAT-Study-Guide-2016/dp/1457304309/ref=sr_1_cc_1?s=aps&ie=UTF8&qid=1491749408&sr=1-1-catcorr&keywords=SAT+study+guide";
				if (link == 'lorax') {
					var win = window.open(lorax, '_blank');
					win.focus();
				}
				if (link == "pi") {
					var win = window.open(pi, '_blank');
					win.focus();
				}
				if (link == "drone") {
					var win = window.open(drone, '_blank');
					win.focus();
				}
				if (link == "sat") {
					var win = window.open(sat, '_blank');
					win.focus();
				}
			}
		}, {
			key: 'buy',
			value: function buy() {
				swal("Great work!", "You just purchased The Lorax by Dr. Suess - and you've earned it yourself!", "success");
				$.get("https://hackpsu-2017spring-yehyaawad.c9users.io:8081/buy/7.38", function (data) {});
			}
		}, {
			key: 'percentage',
			value: function percentage(amount, cost) {
				if (amount / cost * 100 >= 100) {
					return _react2.default.createElement(
						_Button2.default,
						{ onClick: this.buy, style: { backgroundColor: 'green', color: 'white', fontSize: '20px' } },
						'100%'
					);
				} else {
					var num = amount * 100 / cost;
					return num.toFixed(2) + '%';
				}
			}
		}, {
			key: 'fixCost',
			value: function fixCost(cost) {
				var num = cost;
				return num.toFixed(2);
			}
		}, {
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'table',
						{ className: 'table', style: { fontSize: '25px' } },
						_react2.default.createElement(
							'tbody',
							null,
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									null,
									'$',
									this.fixCost(this.state.items[0].cost)
								),
								_react2.default.createElement(
									'th',
									{ className: this.percentage(this.props.amount, this.state.items[0].cost) == 100 ? 'green' : '' },
									this.percentage(this.props.amount, this.state.items[0].cost)
								)
							),
							_react2.default.createElement(
								'tr',
								{ onClick: function onClick() {
										return _this7.amazon('pi');
									} },
								_react2.default.createElement(
									'th',
									{ className: 'underline' },
								...
								_react2.default.createElement(
									...
									null,
									'$',
									this.fixCost(this.state.items[1].cost)
								),
								_react2.default.createElement(
									'th',
									{ className: this.percentage(this.props.amount, this.state.items[1].cost) == 100 ? 'green' : '' },
									this.percentage(this.props.amount, this.state.items[1].cost)
								)
							),
							_react2.default.createElement(
								'tr',
								{ onClick: function onClick() {
										return _this7.amazon('drone');
									} },
								_react2.default.createElement(
									'th',
									{ className: 'underline' },
								...
								_react2.default.createElement(
									...
									null,
									'$',
									this.fixCost(this.state.items[2].cost)
								),
								_react2.default.createElement(
									'th',
									{ className: this.percentage(this.props.amount, this.state.items[2].cost) == 100 ? 'green' : '' },
									this.percentage(this.props.amount, this.state.items[2].cost)
								)
							),
							_react2.default.createElement(
								'tr',
								{ onClick: function onClick() {
										return _this7.amazon('sat');
									} },
								_react2.default.createElement(
									'th',
									{ className: 'underline' },
								...
								_react2.default.createElement(
									...
									null,
									'$',
									this.fixCost(this.state.items[3].cost)
								),
								_react2.default.createElement(
									'th',
									{ className: this.percentage(this.props.amount, this.state.items[3].cost) == 100 ? 'green' : '' },
									this.percentage(this.props.amount, this.state.items[3].cost)
								)
							)
						)
					)
	...
	var Stats = function (_React$Component5) {
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									{ style: { color: 'green' } },
									'$',
									this.props.earnings + Number(this.props.amount)
								)
							),
							_react2.default.createElement(
								'tr',
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'th',
									{ style: { color: 'red' } },
									this.props.amount - this.props.spent
								),
								_react2.default.createElement(
									'th',
									{ style: { color: 'green' } },
									'$',
									this.props.earnings + Number(this.props.amount) - (this.props.spent + 50)
								)
							)
						)
					)
	...
	var Clock = function (_React$Component6) {
		...
		function Clock() {
			...
			//var dueDate = new Date(2017,4,15);
			var _this9 = _possibleConstructorReturn(this, (Clock.__proto__ || Object.getPrototypeOf(Clock)).call(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objectWithoutProperties2 = __webpack_require__(196);

	var _objectWithoutProperties3 = _interopRequireDefault(_objectWithoutProperties2);

	var _extends3 = __webpack_require__(197);
	...
	var _bootstrapUtils = __webpack_require__(252);

	var _StyleConfig = __webpack_require__(257);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(169)(IteratorPrototype, __webpack_require__(220)('iterator'), function(){ return this; });
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(167)(Function.call, __webpack_require__(237).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _entries = __webpack_require__(253);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(166).Object.entries;
